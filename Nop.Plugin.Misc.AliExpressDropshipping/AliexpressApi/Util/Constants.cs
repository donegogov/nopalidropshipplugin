...
namespace Nop.Plugin.Misc.AliExpress.Dropshipping.AliexpressApi.Util
{
    public sealed class Constants
    {
        ...
        public const string LOG_FILE_NAME = "iopsdk.log";

        public const string ACCEPT_ENCODING = "Accept-Encoding";
        public const string CONTENT_ENCODING = "Content-Encoding";
        public const string CONTENT_ENCODING_GZIP = "gzip";

        public const string SDK_VERSION = "iop-sdk-net";
        ...
        public const string ACCESS_TOKEN = "session";
        ...
        public const string RSP_ERR_RSP = "error_response";
