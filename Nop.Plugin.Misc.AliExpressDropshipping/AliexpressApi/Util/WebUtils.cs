...
namespace Nop.Plugin.Misc.AliExpress.Dropshipping.AliexpressApi.Util
{
    /// <summary>
    /// web tools 
    /// </summary>
    public sealed class WebUtils
    {
        ...
        public string DoDel(string url, IDictionary<string, string> textParams)
        {
            ...
            HttpWebRequest req = GetWebRequest(url, "DELETE", null);
            req.ContentType = "application/x-www-form-urlencoded;charset=utf-8";
        ...
        public string DoPut(string url, IDictionary<string, string> textParams, IDictionary<string, string> headerParams)
        {
            if (textParams != null && textParams.Count > 0)
            {
                url = BuildRequestUrl(url, textParams);
            ...
            HttpWebRequest req = GetWebRequest(url, "PUT", headerParams);
            req.ContentType = "application/x-www-form-urlencoded;charset=utf-8";
