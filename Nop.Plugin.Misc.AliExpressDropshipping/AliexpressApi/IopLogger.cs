using Nop.Plugin.Misc.AliExpress.Dropshipping.AliexpressApi.Util;
using System;
...
namespace Nop.Plugin.Misc.AliExpress.Dropshipping.AliexpressApi
{
    ...
    /// <summary>
    ///  IOP default logger 
    ///  DefaultIopLogger.Instance.LogDirectory=@"./"; default is application rumtime directory
    ///  DefaultIopLogger.Instance.LogWrite("aa");
    ///  DefaultIopLogger.Instance.LogWrite("aa", MsgLevel.Debug);
    /// </summary>
    public class IopLogger : IDisposable, IIopLogger
    {
        private static IopLogger _instance = null;
        ...
        private string _fileNamePrefix = "iopsdk_";
        /// <summary>
        /// log prefix name
        /// </summary>
        ...
        public void TraceApiError(string appKey, String sdkVersion, string apiName, string url, System.Collections.Generic.Dictionary<string, string> parameters, double latency, string errorMessage)
        {
            ...
            info.Append(apiName);
            info.Append(Constants.LOG_SPLIT);
            info.Append(IopUtils.GetIntranetIp());
            info.Append(Constants.LOG_SPLIT);
